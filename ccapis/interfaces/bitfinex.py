...
# Import Homebrew
from ccapis.apis.REST import BitfinexREST
# from bitex.api.WSS.bitfinex import BitfinexWSS
from ccapis.formatters.base import return_api_response
from ccapis.formatters.bitfinex import BitfinexFormatter as fmt
...
class Bitfinex(BitfinexREST):
    ...
    async def ticker(self, base, counter, sync=True, **kwargs):
        ...
        if not sync:
            ...
            return await self.async_public_query('pubticker/%s' % pair, params=kwargs)
