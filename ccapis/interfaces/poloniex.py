...
# Import Homebrew
from ccapis.apis.REST import PoloniexREST
# from bitex.api.WSS.poloniex import PoloniexWSS
from ccapis.formatters.base import return_api_response
from ccapis.formatters.poloniex import PoloniexFormatter as fmt
...
class Poloniex(PoloniexREST):
    ...
    async def ticker(self, base, counter, **kwargs):
        ...
        return await self.public_query('returnTicker', params=kwargs)
